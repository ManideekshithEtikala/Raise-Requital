...
export const Navbar = () => {
  ...
  return (
    ...
    <>
      <div className="flex justify-between bg-blue-900 py-5 px-5 bg-transparent">
        ...
        <div className="flex justify-end items-center w-full">
          <div className="flex justify-center items-center">
            <span className="mx-2 text-white cursor-pointer">Explore</span>
          </div>
          <div className="flex items-center rounded-md justify-around mx-4 bg-white text-sm">
            <input
              className="px-2 py-1 mx-2 rounded-md outline-none bg-transparent text-gray-700"
          ...
          <div>
            ...
            ):<Link to={"/login"}  className="bg-transparent hover:text-purple-600 p-2 rounded-md text-white cursor-pointer ">Loign</Link>
            }
