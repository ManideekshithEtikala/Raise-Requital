    ...
    <>
      <div className="flex flex-col sm:flex-row h-[80vh] md:h-[90vh]">
        ...
        <div className="w-full flex flex-col justify-center items-center ">
          ...
          >
            Discover <span className="text-3xl sm:text-[3rem] md:text-[3.5rem] text-blue-gray-900 flex flex-col justify-center font-serif items-center sm:py-2 font-bold text-center lg:text-[4rem] lg:mt-6">Start ups</span>
